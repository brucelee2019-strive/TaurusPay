...
public class ScreenUtils {
     ...
     * 设置屏幕亮度
     */
    public static void setScreenBrightness(final Activity context, float f) {
    ...
    //获取虚拟按键的高度
    public static int getNavigationBarHeightCheck(Context context, boolean check) {
        int result = 0;
        if (check) {
    ...
    public static float getActionBarHeight(){
        TypedArray actionbarSizeTypedArray = MyFrameApplication.getInstance().obtainStyledAttributes(new int[]{android.R.attr.actionBarSize});
