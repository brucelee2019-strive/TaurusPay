...
/**
 * @author : Bruce Lee
 * @date : 2020/1/12 0012 14:27
 * @description :
 */
public class LowerRechargeSucceedFragment extends BasePresentListFragment<LowerRecordPresenter> implements LowerRecordConstract.View{
    ...
    protected void initFragment() {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                page = 0;
                presenter.getRechargeAuditList(PreferencesUtils.getString(getContext(), "token"), 4, page);
            }
        });
    }
